...
import main.model.table.FacilityTableModel;
import main.service.FacilityService;
 ...
 * @author aldes
 */
public class MasterFacilityForm extends JPanel {
    ...
    private void populateForm(Facility facility) {
        ...
        if (id != null) {
            groupId.getInputField().setText(String.valueOf(facility.getId()));
        }
        ...
        try {
            Validation formValidation = new Validation()
                    .addItem(new ValidationItem("Nama", groupName.getInputField())
                            ...
                            .addRule(new RuleUnique("facilities", "name", isInsert ? null : id))
                    );
